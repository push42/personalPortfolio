...
<head>
    <title>Websites | Thies Bergenthal</title>
        ...
        <div class="content">
            <div class="relative p-10">
                <div class="max-w-4xl mx-auto text-center">
                    <h1 class="text-6xl font-extrabold mb-2 tracking-widest animate-pulse"><span class="text-transparent bg-clip-text bg-gradient-to-tr from-[#8088f8] to-[#e67194]">Mein</span>
                        Webdev Portfolio.</span></h1>
                    <!-- <p class="text-3xl mb-6 font-light">Fully functional & responsive on all devices</p> -->
                    <!-- <div class="mt-2 text-xl font-medium">Werfen Sie einen Blick in meinen Source Code &amp; eine Live Preview</div> -->
                </div>
            </div>
        </div>
    </div>
        ...
        <section class="teteteetete">
            <div class="container px-6 py-10 mx-auto">
                <h1 class="text-2xl font-semibold text-center text-gray-800 lg:text-3xl dark:text-white myWorkDescription">
                    Fertige, <span class="text-transparent bg-clip-text bg-gradient-to-tr from-[#8088f8] to-[#e67194]">voll
                        Funktionsfähige</span> Websites</h1>
                        ...
                        <ol class="flex w-full flex-wrap items-center rounded-md bg-zinc-800 bg-opacity-60 py-2 px-4">
                            <li class="flex cursor-pointer items-center text-sm font-normal leading-normal text-gray-300 antialiased transition-colors duration-300 hover:text-purple-500">
                                <a class="opacity-60" href="avatar.php">
                                    <span><i class="fa-solid fa-bars mr-2 text-transparent bg-clip-text bg-gradient-to-tr from-[#8088f8] to-[#e67194]"></i>Avatare
                                        & Logos</span>
                                </a>
                            ...
                            <li class="flex cursor-pointer items-center text-sm font-normal leading-normal text-gray-300 antialiased transition-colors duration-300 hover:text-purple-500">
                                <a class="font-medium text-gray-100 transition-colors hover:text-purple-500" href="websites.php">
                ...
                <div class="grid grid-cols-1 gap-8 mt-8 md:mt-16 md:grid-cols-2">
                    ...
                    <div class="lg:flex">
                        <div class="portImage relative">
                            <a href="#none">
                                <i class="fa-solid fa-up-right-and-down-left-from-center absolute top-4 right-4 z-50"></i>
                                <img class="object-cover w-full h-56 rounded-lg lg:w-64 workIMG" src="./assets/work/websites/portfolio_v1.png" alt="">
                            </a>
                        </div>
                        <div class="flex flex-col py-6 lg:mx-6">
                            <a href="#" class="text-xl font-semibold text-gray-800 dark:text-white ">
                                <span class="text-transparent bg-clip-text bg-gradient-to-tr from-[#8088f8] to-[#e67194]">PortfolioV1</span>
                                Website
                            </a>
                            <span class="text-sm text-gray-500 dark:text-gray-300 mb-2 myWorkDescription">Portfolio |
                                Thies Bergenthal</span>
                            <div class="buttonSpacerText mb-2 mt-1 text-sm font-semibold text-gray-300">Verwendete Sprachen
                            </div>
                            <!-- component -->
                            <div class="flex">
                    ...
                    <div class="lg:flex">
                        <div class="portImage relative">
                            <a href="#none">
                                <i class="fa-solid fa-up-right-and-down-left-from-center absolute top-4 right-4 z-50"></i>
                                <img class="object-cover w-full h-56 rounded-lg lg:w-64 workIMG" src="./assets/work/websites/roguev.png" alt="">
                            </a>
                        </div>
                        <div class="flex flex-col py-6 lg:mx-6">
                            <a href="#" class="text-xl font-semibold text-gray-800 dark:text-white ">
                            ...
                            <span class="text-sm text-gray-500 dark:text-gray-300 mb-2 myWorkDescription">RogueV | FiveM
                                Gameserver</span>
                            <div class="buttonSpacerText mb-2 mt-1 text-sm font-semibold text-gray-300">Verwendete Sprachen
                            </div>
                            <!-- component -->
                    ...
                    <div class="lg:flex">
                        <div class="portImage relative">
                            <a href="#none">
                                <i class="fa-solid fa-up-right-and-down-left-from-center absolute top-4 right-4 z-50"></i>
                                <img class="object-cover w-full h-56 rounded-lg lg:w-64 workIMG" src="./assets/work/websites/roguev_dashboard.png" alt="">
                            </a>
                        </div>
                        <div class="flex flex-col py-6 lg:mx-6">
                            <a href="#" class="text-xl font-semibold text-gray-800 dark:text-white ">
                        ...
                        <div class="flex flex-col py-6 lg:mx-6">
                            <a href="#" class="text-xl font-semibold text-gray-800 dark:text-white ">
                                <span class="text-transparent bg-clip-text bg-gradient-to-tr from-[#8088f8] to-[#e67194]">FiveM
                                    Scripts</span> Website
                            </a>
                            <span class="text-sm text-gray-500 dark:text-gray-300 mb-2 myWorkDescription">FiveM Scripts
                                | Personal Shop</span>
                            <div class="buttonSpacerText mb-2 mt-1 text-sm font-semibold text-gray-300">Verwendete Sprachen
                            </div>
                            <!-- component -->
                    ...
                    <div class="lg:flex">
                        <div class="portImage relative">
                            <a href="#none">
                                <i class="fa-solid fa-up-right-and-down-left-from-center absolute top-4 right-4 z-50"></i>
                                <img class="object-cover w-full h-56 rounded-lg lg:w-64 workIMG" src="./assets/work/websites/yakuji2.info.webp" alt="">
                            </a>
                        </div>
                        <div class="flex flex-col py-6 lg:mx-6">
                            <a href="#" class="text-xl font-semibold text-gray-800 dark:text-white ">
                ...
                <h1 class="mt-4 text-2xl font-semibold text-center text-gray-800 lg:text-3xl dark:text-white myWorkDescription">
                    Mehr <span class="text-transparent bg-clip-text bg-gradient-to-tr from-[#8088f8] to-[#e67194]">unfertige
                        Projekte.</span></h1>
                <div class="grid grid-cols-1 gap-8 mt-8 md:mt-16 md:grid-cols-2">
                    <div class="lg:flex">
                        <div class="portImage relative">
                            <a href="#none">
                                <i class="fa-solid fa-up-right-and-down-left-from-center absolute top-4 right-4 z-50"></i>
                                <img class="object-cover w-full h-56 rounded-lg lg:w-64 workIMG" src="./assets/work/websites/roguev_dashboard2.png" alt="">
                            </a>
                        </div>
                        <div class="flex flex-col py-6 lg:mx-6">
                            <a href="#" class="text-xl font-semibold text-gray-800 dark:text-white ">
                    ...
                    <div class="lg:flex">
                        <div class="portImage relative">
                            <a href="#none">
                                <i class="fa-solid fa-up-right-and-down-left-from-center absolute top-4 right-4 z-50"></i>
                                <img class="object-cover w-full h-56 rounded-lg lg:w-64 workIMG" src="./assets/work/websites/blue_design.webp" alt="">
                            </a>
                        </div>
                        <div class="flex flex-col py-6 lg:mx-6">
                            <a href="#" class="text-xl font-semibold text-gray-800 dark:text-white ">
                                <span class="text-transparent bg-clip-text bg-gradient-to-tr from-[#8088f8] to-[#e67194]">ICYGLIZZY</span>
                                Website
                            </a>
                            <span class="text-sm text-gray-500 dark:text-gray-300 mb-2 myWorkDescription">IcyGlizzy |
                                Redirect Page</span>
                            <div class="buttonSpacerText mb-2 mt-1 text-sm font-semibold text-gray-300">Verwendete Sprachen
                            </div>
                            <!-- component -->
                    ...
                    <div class="lg:flex">
                        <div class="portImage relative">
                            <a href="#none">
                                <i class="fa-solid fa-up-right-and-down-left-from-center absolute top-4 right-4 z-50"></i>
                                <img class="object-cover w-full h-56 rounded-lg lg:w-64 workIMG" src="./assets/work/websites/green_design.webp" alt="">
                            </a>
                        </div>
                        <div class="flex flex-col py-6 lg:mx-6">
                            <a href="#" class="text-xl font-semibold text-gray-800 dark:text-white ">
                    ...
                    <div class="lg:flex">
                        <div class="portImage relative">
                            <a href="#none">
                                <i class="fa-solid fa-up-right-and-down-left-from-center absolute top-4 right-4 z-50"></i>
                                <img class="object-cover w-full h-56 rounded-lg lg:w-64 workIMG" src="./assets/work/websites/red_design.webp" alt="">
                            </a>
                        </div>
                        <div class="flex flex-col py-6 lg:mx-6">
                            <a href="#" class="text-xl font-semibold text-gray-800 dark:text-white ">
