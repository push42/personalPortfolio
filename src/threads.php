...
<head>
    <title>Threads | Thies Bergenthal</title>
        ...
        <div class="content">
            <div class="relative p-10">
                <div class="max-w-4xl mx-auto text-center">
                    <h1 class="text-6xl font-extrabold mb-2 tracking-widest animate-pulse">Forum<span class="text-transparent bg-clip-text bg-gradient-to-tr from-[#8088f8] to-[#e67194]"> Thread </span>Designs</span></h1>
                        ...
                        <ol class="flex w-full flex-wrap items-center rounded-md bg-zinc-800 bg-opacity-60 py-2 px-4">
                            ...
                            <li class="flex cursor-pointer items-center text-sm font-normal leading-normal text-gray-300 antialiased transition-colors duration-300 hover:text-purple-500">
                                <a class="opacity-60" href="banner.php">
                                    <span><i class="fa-solid fa-bars mr-2 text-transparent bg-clip-text bg-gradient-to-tr from-[#8088f8] to-[#e67194]"></i>Banner
                                    </span>
                                </a>
                            ...
                            <li class="flex cursor-pointer items-center text-sm font-normal leading-normal text-gray-300 antialiased transition-colors duration-300 hover:text-purple-500">
                                <a class="font-medium text-gray-100 transition-colors hover:text-purple-500" href="threads.php">
                                    <i class="fa-solid fa-bars mr-2 text-transparent bg-clip-text bg-gradient-to-tr from-[#8088f8] to-[#e67194]"></i>Forum Threads
                                </a>
                ...
                <div class="grid grid-cols-1 gap-8 mt-8 md:mt-16 md:grid-cols-2">
                    <div class="lg:flex">
                        <div class="portImage relative">
                            <a href="#none">
                                ...
                                <img class="object-cover w-full h-56 rounded-lg lg:w-64 workIMG" src="./assets/work/thread/21111.gif" alt="">
                            </a>
                        </div>
                        <div class="flex flex-col py-6 lg:mx-6">
                            ...
                            <span class="text-sm text-gray-500 dark:text-gray-300 mb-2 myWorkDescription">Metin2 Gameserver</span>
                    ...
                    <div class="lg:flex">
                        <div class="portImage relative">
                            <a href="#none">
                                <i class="fa-solid fa-up-right-and-down-left-from-center absolute top-4 right-4 z-50"></i>
                                <img class="object-cover w-full h-56 rounded-lg lg:w-64 workIMG" src="./assets/work/thread/bigloadingscreen_1 (1).png" alt="">
                            </a>
                        </div>
                        <div class="flex flex-col py-6 lg:mx-6">
                            <a href="#" class="text-xl font-semibold text-gray-800 dark:text-white ">
                    ...
                    <div class="lg:flex">
                        <div class="portImage relative">
                            <a href="#none">
                                <i class="fa-solid fa-up-right-and-down-left-from-center absolute top-4 right-4 z-50"></i>
                                <img class="object-cover w-full h-56 rounded-lg lg:w-64 workIMG" src="./assets/work/thread/burger-shot.png" alt="">
                            </a>
                        </div>
                        <div class="flex flex-col py-6 lg:mx-6">
                            <a href="#" class="text-xl font-semibold text-gray-800 dark:text-white ">
                    ...
                    <div class="lg:flex">
                        <div class="portImage relative">
                            <a href="#none">
                                <i class="fa-solid fa-up-right-and-down-left-from-center absolute top-4 right-4 z-50"></i>
                                <img class="object-cover w-full h-56 rounded-lg lg:w-64 workIMG" src="./assets/work/thread/serverwerbung(1)_1.gif" alt="">
                            </a>
                        </div>
                        <div class="flex flex-col py-6 lg:mx-6">
                            <a href="#" class="text-xl font-semibold text-gray-800 dark:text-white ">
                    ...
                    <div class="lg:flex">
                        <div class="portImage relative">
                            <a href="#none">
                                <i class="fa-solid fa-up-right-and-down-left-from-center absolute top-4 right-4 z-50"></i>
                                <img class="object-cover w-full h-56 rounded-lg lg:w-64 workIMG" src="./assets/work/thread/shop_preview.png" alt="">
                            </a>
                        </div>
                        <div class="flex flex-col py-6 lg:mx-6">
                            <a href="#" class="text-xl font-semibold text-gray-800 dark:text-white ">
                                <span class="text-transparent bg-clip-text bg-gradient-to-tr from-[#8088f8] to-[#e67194]">PUSH42</span>
                                FiveM Scripts
                            </a>
                            <span class="text-sm text-gray-500 dark:text-gray-300 mb-2 myWorkDescription">FiveM Script Shop</span>
                            <div class="buttonSpacerText mb-2 mt-1 text-sm font-semibold text-gray-300">Verwendete Tools
                            </div>
                            <!-- component -->
                            <div class="flex">
